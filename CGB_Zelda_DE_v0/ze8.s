...
;-------------<	ZPL >-------------
		...
		extern	NXGOTO3,LDTIM1,LDTIM3,BG1CHG,PLPTSTL,PLSDCL,PBULE
		extern	PLPTST,NXGOTO4,MSGCH3,DUSHCL2,CARITMD,PTOBI,POVER
		extern	PINDR1,PMOVE,PFOLE,PTATE,PMGIC,POKAR,FDIN,PSWIM
		extern	PBOXER,LOVED,GMAP,PBUME,ENDG,GPLAY
;
;-------------<	ZES >-------------
...
;-------------<	ZEN >-------------
		...
		extern	SLIMS,ARIMA,PYAAA,ZONBI,TODD,USAGI,ONPU,AKUMA,PEACH
		extern	MVHAS,WANI,GAGE,GIRL1,WANWAN,OBAKE,PUKPK,PUKPJ
		extern	HASIR,FIREB,POWDR,KAZAM,NIWAX,SEIREN,KENBM,SARUK
		extern	AMUST,BOSS,HODAI,SKEL1,SANBO,MORYA,IWAGO,SWBLKU
		extern	SWBLKD
;
;==============	バンク８ ================================================
BANK8		GROUP	8
...
;;;;;;;;	EXTERN	MIZUB,SLOT,HART1,RUPY1,OCHAN,KAKIN,SLIMS,PSWIM,ARIMA,PYAAA
...
;;;;;;;;	EXTERN	GMAP,SEIREN,KENBM,PBUME,HNSM,SARUK,BGCRRD,AMUST,ENDG,BOSS
...
;;;11/25	LD	HL,ENMOD3
;;;11/25	ADD	HL,BC
;;;11/25	LD	(HL),%10010000
;;;11/25;
;;;11/25	CALL	CRKNENL
;;;11/25;
;;;11/25	LD	HL,ENMOD3
;;;11/25	ADD	HL,BC
;;;11/25	LD	(HL),%11010000
;
	LD	HL,ENLIFE
	ADD	HL,BC
	LD	A,(HL)
