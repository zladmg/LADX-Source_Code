...
;-------------<	ZPL >-------------
		...
		extern	NMCPY,GPMAIN,MSCHN2R,PRN
;
;-------------<	ZMA >-------------
...
;;;;;;;;	EXTERN	CURSDST,CURSDSS,BGMSET,MSCHNOR,MSCHN2R
...
PSI0011
	...
	LD	(HLI),A
	DEC	C
	JR	NZ,PSI0011				; yes ! KILL MODE BG set !
;
PMA100
;
	CALL	CURSDST	;(S)
...
;				; yes !
	JP	ITMINC
PSLM10
;;; 妖精カ－ソル　セット　柴原 やらんかあああ！！！
;;; 誰が  柴原ですねん！！！　い－ですよ，い－ですよ　森田さん！
;;
...
;
NMZHYO
	DB	$42,$C5,$43,$44,$45,$46,$47,0,0,$62,$E5,$63,$64,$65,$66,$67
	DB	$48,$49,$4A,$4B,$4C,$4D,$4E,0,0,$68,$69,$6A,$6B,$6C,$6D,$6E
	DB	$4F,$50,$D7,$51,$52,$53,$54,0,0,$6F,$70,$F7,$71,$72,$73,$74
	DB	$55,$56,$DD,$57,$58,$59,$5A,0,0,$E0,$75,$76,$FD,$77,$78,$79
	DB	$5B,000,000,000,000,000,000,0,0,$7A,$7B,000,000,000,000,000
;
...
;
	DB	$99,$E4,$0D
	DB	$19,$14,$11,$14,$02,$0A,$6B,$6C,$6D,$6E,$0C
	DB	$04,$0D,$14
	DB	$00
	DB	$00
OKCLDT2	;COPY
...
;
	DB	$99,$E3,$0E
	DB	$19,$14,$11,$14,$02,$0A,$7E,$19,$14,$0C,$7E
	DB	$0C,$04,$0D,$14
	DB	$00
;- - - - - - - - - - - - - - - - - - -
OKCLEAR
...
;1998/11/11;	DW	GRMIT00
;1998/11/11;	DW	GRMIT08
;1998/11/11;	DW	GRMIT0C
;1998/11/11;	DW	GRMIT10
;1998/11/11;	DW	GRMMAIN
;1998/11/11;	DW	GRMMA00
;
;=======================================================
;	カラーデータの退避
;=======================================================
