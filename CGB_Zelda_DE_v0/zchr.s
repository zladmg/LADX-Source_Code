...
BANKC		group	00ch
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm1.cgx
;
BANKD		group	00dh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm2.cgx
;
BANKE		group	00eh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm3.cgx
;
BANKF		group	00fh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm4.cgx
;
BANK10		group	010h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm5.cgx
;
BANK11		group	011h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm6.cgx
;
BANK12		group	012h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm7.cgx
;
BANK13		group	013h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_gm8.cgx
;
BANK34		GROUP	$34
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gb_gm9.cgx
;
;
;xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
BANK2C		GROUP	$2c
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb1.cgx

BANK2D		GROUP	$2d
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb2.cgx

BANK2E		GROUP	$2e
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb3.cgx

BANK2F 		GROUP	$2f
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb4.cgx

BANK30		GROUP	$30
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb5.cgx

BANK31		GROUP	$31
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb6.cgx

BANK32		GROUP	$32
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb7.cgx

BANK33		GROUP	$33
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/gmcgb8.cgx

BANK35		GROUP	$35
		ORG	$4000
		binset	$0,$2000
		libbin	cgx/gmcgb9.cgx

;;;;;;;;FUKU_DJ_CHR	EQU	$6000
;;;;;;;;CAMERA_CHR	EQU	$6000+$0600
;;;;;;;;		ORG	$6000
		binset	$0,$2000
FUKU_DJ_CHR	libbin	cgx/gmcgba.cgx
