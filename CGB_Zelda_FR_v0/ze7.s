...
;-------------<	ZPL >-------------
		...
		extern	NXGOTO3,LDTIM1,LDTIM3,BG1CHG,PLPTSTL,PLSDCL,POVER
		extern	PLPTST,NXGOTO4,MSGCH3,DUSHCL2,CARITMD,PTOBI,PBULE
		extern	PINDR1,PMOVE,PFOLE,PTATE,PMGIC,POKAR,PSWIM,PBOXER
		extern	LOVED,GMAP,PBUME,PKEN,PLHKCK,PLHKC0,PLHKXD,PLHKYD
		extern	PBOMB,PYAST,SCSTR,GPLAY,ENDG
;
;-------------<	ZES >-------------
...
BANK2		GROUP	2
;-------------<	ZEX >-------------
		extern	DJRMRD,SPUNDT,WTUP,SMK1,RZNZ,FLSH,BFZN,DSZN,HNSM
		extern	KZNZ
;
;==============	バンク３ ================================================
BANK3		GROUP	3
;-------------<	ZEN >-------------
		...
		extern	PANEL,BHANA,SHANA,HEIS0,MORI1,OCTA1,FDIN,KODOMB
		extern	IZUMI,SONIC,KEYSM,MIZUB,SLOT,HART1,RUPY1,OCHAN
		extern	KAKIN,SLIMS,OZWAN,ARIMA,PYAAA,ZONBI,TODD,USAGI,ONPU
		extern	AKUMA,PEACH,MVHAS,WANI,GAGE,GIRL1,WANWAN,OBAKE
		extern	PUKPK,PUKPJ,HASIR,FIREB,POWDR,KAZAM,NIWAX,SEIREN
		extern	KENBM,AMUSI,HIKUS,MOAI
;
;==============	バンク８ ================================================
BANK8		GROUP	8
;-------------<	ZBD >-------------
...
;;;;;;;;	EXTERN	CRKNKNL,LDTIM1,LDTIM3,BG1CHG,PLPTSTL,PLSDCL,PLPTST,NXGOTO4,MSGCH3
;;;;;;;;	EXTERN	DUSHCL2,HABATAKI
;;;;;;;;;
...
;;;;;;;;	EXTERN	PBOXER,LOVED,ZONBI,TODD,USAGI,ONPU,AKUMA,PEACH,MVHAS,WANI,GAGE
;;;;;;;;	EXTERN	GIRL1,WANWAN,OBAKE,PUKPK,PUKPJ,HASIR,FIREB,POWDR,KAZAM,NIWAX
;;;;;;;;	EXTERN	GMAP,SEIREN,KENBM,PBUME,HNSM,PKEN,KZNZ,AMUSI,HIKUS
;;;;;;;;	EXTERN	PLHKCK,PLHKC0,PLHKXD,PLHKYD
;;;;;;;;	EXTERN	PBOMB,PYAST,MOAI
;------------------------------------------------
;------------------------------------------------
	KANJI
	PAGE
...
;	アトリビュートセット
;
		LD	C,GAGEBD2_end-GAGEBD_atr
		LD	A,GAGEBD2_end-GAGEBD_atr-1
		LD	(VRAMD_AT),A
		LD	HL,VRAMD_AT+1	
		LD	DE,GAGEBD_atr
GAG200
