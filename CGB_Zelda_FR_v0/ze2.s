...
;
;-------------<	ZES >-------------
		extern	ISIBRKL,CRENENL,BSSDCK,ENBGCKL,ENBGCK2L,ENPTST
		extern	STATINC,ENIDSHL,ENIDSH2L,CREPKEL,CRENPLL,CRENPL2L
		extern	EN2CST,EN1CST,PSERCHL,PSERCH2L,CRKNENL,CRENPSL
		extern	ENPSSV,ENSDCL,NXOMSBL,PLBGCKL,ENALCL,HNSMST,ENOMST
		extern	ITEMGETS,SHRVSE,ENMDSTL,EFAIL,EFOLE,EFIRE,EINIT
...
BANK2		GROUP	2
;-------------<	ZEX >-------------
		extern	SPUNDT,WTUP,SMK1,RZNZ,FLSH
;
;==============	バンク３ ================================================
BANK3		GROUP	3
;-------------<	ZEN >-------------
		extern	EFLSST,HARTB,R7BEM,RENO7,BGKAO,FUCKS,UFOCH,TERSA
		extern	FISHG,SBOMB,BOMBR,NINTM,HAYAB,KTOBJ,BSLIM,SLIMB
		extern	TBOSS,SLIMS,KAKER,BHOLE,KAKIN,AKUMA
;
;==============	バンク８ ================================================
BANK8		GROUP	8
;-------------<	ZBD >-------------
...
;
	...
	LIB	ZBN
;
;;;;;;;;	EXTERN	RNDSUB,PLPSRV,MSGCHK,MSGCH2,MSGCHK2,DUSHCL,OBJBG,KNCSET,KNFLSH,ISIBRKL
;;;;;;;;	EXTERN	PLSHST,MVCALC,FLASHST,DJRMRD,EXIDSH,SPUNDT,NXGOTO,CRENENL,BSSDCK
;;;;;;;;	EXTERN	ENMOVE,ENBGCKL,ENBGCK2L,LDTIM0,ENPTST,STATINC,ENIDSHL,ENIDSH2L
;;;;;;;;	EXTERN	CREPKEL,CRENPLL,CRENPL2L,EN2CST,EN1CST,PSERCHL,PSERCH2L,CRKNENL
;;;;;;;;	EXTERN	CRENPSL,ENPSSV,ENSDCL,NXOMSBL,EFLSST,PLBGCKL,ENALCL,HNSMST,ENOMST
;;;;;;;;	EXTERN	SOUNDCLR,ITEMGETS,ENHNCL,SHRVSE,YOSSISET,DUSHCL2
;;;;;;;;	EXTERN	ENMDSTL,BBSDST,NXGOTO4,LDTIM1,LDTIM3,BGCRRD,PLPTSTL
;;;;;;;;;
...
;;;;;;;;	EXTERN	PFOLE,KTOBJ,BSLIM,SLIMB,TBOSS,PBOMB,PMGIC,SLIMS,PSKOP
;;;;;;;;	EXTERN	PYAST,POKAR,PTATE,KAKER,BHOLE,KAKIN,AKUMA
;;;;;;;;	EXTERN	GMAP
;------------------------------------------------
	KANJI
	PAGE
