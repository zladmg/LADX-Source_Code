...
;-------------<	ZES >-------------
		...
		extern	PLBGCKL,ENALCL,HNSMST,ENOMST,ENSZST,SADWSTL
		extern	SHRVSE,ITEMGETS,ENBITON,WAENCK,EFAIL,EFOLE,EFIRE
...
BANK2		GROUP	2
;-------------<	ZEX >-------------
		extern	SPUNDT,BGMSET,WTUP,SMK1,RZNZ,FLSH,BFZN
;
;==============	バンク３ ================================================
BANK3		GROUP	3
;-------------<	ZEN >-------------
		...
		extern	SLIMB,TBOSS,BSNAK,GORMA,BSKEL,BFIRE,BBIRD,BFISH
		extern	SWTRP,NIWAT,KODOMA,PAPA0,KAMEI,YOSSI,BHANA,SHANA
		extern	HEIS0,MORI1,OCTA1,KODOMB,IZUMI,SONIC,MONKY,WANWAN
		extern	ONPU,BLANKA,IKADA,KAIIN,BABA0
;
;==============	バンク８ ================================================
BANK8		GROUP	8
;-------------<	ZBD >-------------
...
;;;;;;;;	EXTERN	PLXCLC,PBSET,ENHNCL,ENSZST,BBSDST,SADWSTL,MSGCH2,BHFIR
;;;;;;;;	EXTERN	SHRVSE,SOUNDCLR,ITEMGETS,ENBITON,NXGOTO3,BGMSET,YOSSISET
;;;;;;;;	EXTERN	LDTIM1,LDTIM3,PLPTSTL,DUSHCL2,HABATAKI,MSGCH3
;;;;;;;;	EXTERN	WAENCK
;;;;;;;;;
...
;;;;;;;;	EXTERN	PFOLE,KTOBJ,BSLIM,SLIMB,TBOSS,BSNAK,GORMA,BSKEL,BFIRE,BFZN,BBIRD
;;;;;;;;	EXTERN	BFISH,SWTRP,PTATE,PMGIC,POKAR,NIWAT,KODOMA,PAPA0,KAMEI,YOSSI,PEACH
;;;;;;;;	EXTERN	BHANA,SHANA,HEIS0,MORI1,OCTA1,FDIN,KODOMB,IZUMI,SONIC,MONKY,WANWAN
;;;;;;;;	EXTERN	ONPU,BLANKA,IKADA,ENDG,GMAP,KAIIN
;------------------------------------------------
	KANJI
	PAGE
	isdmg
...
;;;KK;;;	CALL	MSGCHK	; Souka Yaritamae !
;;;KK;;;IKJ2010
;;;KK;;;	RET
;================================================
IKJ2020
...
BDCHD10
	...
	DB	%00111111,%00010000
	DB	%00111111,%00011011
;;;11/24	DB	%00000111,%00000000
;;;11/24	DB	%00001111,%00000111
;;;11/24	DB	%00011110,%00001111
;;;11/24	DB	%00111111,%00011000
;;;11/24	DB	%00111111,%00010000
;;;11/24	DB	%00111111,%00010100
;;;11/24	DB	%00111111,%00010000
;;;11/24	DB	%00100111,%00011011
BDCHD11
	DB	%11100000,%00000000
	DB	%11110000,%11100000
	DB	%11111000,%11110000
	DB	%11111100,%01111000
	DB	%11111100,%01110000
	DB	%11111111,%11000000
	DB	%11111111,%00111110
	DB	%11111111,%11110001
;;;11/24	DB	%11100000,%00000000
;;;11/24	DB	%11110000,%11100000
;;;11/24	DB	%00011000,%11110000
;;;11/24	DB	%10001100,%01111000
;;;11/24	DB	%10001100,%01110000
;;;11/24	DB	%00111111,%11000000
;;;11/24	DB	%11111111,%00111110
;;;11/24	DB	%11101111,%11110001
BDCHD20
