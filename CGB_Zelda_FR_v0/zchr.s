...
BANK1B		GROUP	01bh
		org	04000h
		binset	00000h,03800h
		libbin	sound/bgm_1.bin
;
BANK1E		GROUP	01eh
		org	04000h
		binset	00000h,04000h
		libbin	sound/bgm_2.bin
;
BANK1F		GROUP	01fh
		org	04000h
		binset	00000h,03c00h
		libbin	sound/se.bin
;
;
;xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
BANKC		group	00ch
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr1.cgx
;
BANKD		group	00dh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr2.cgx
;
BANKE		group	00eh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr3.cgx
;
BANKF		group	00fh
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr4.cgx
;
BANK10		group	010h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr5.cgx
;
BANK11		group	011h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr6.cgx
;
BANK12		group	012h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr7.cgx
;
BANK13		group	013h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr8.cgx
;
BANK34		group	034h
		org	04000h
		binset	00000h,04000h
		libbin	cgx/gb_fr9.cgx
;
;xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
BANK2C		GROUP	$2c
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb1.cgx

BANK2D		GROUP	$2d
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb2.cgx

BANK2E		GROUP	$2e
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb3.cgx

BANK2F 		GROUP	$2f
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb4.cgx

BANK30		GROUP	$30
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb5.cgx

BANK31		GROUP	$31
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb6.cgx

BANK32		GROUP	$32
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb7.cgx

BANK33		GROUP	$33
		ORG	$4000
		binset	$0,$4000
		libbin	cgx/frcgb8.cgx

BANK35		GROUP	$35
		ORG	$4000
		binset	$0,$2000
		libbin	cgx/frcgb9.cgx

;;;;;;;;FUKU_DJ_CHR	EQU	$6000
;;;;;;;;CAMERA_CHR	EQU	$6000+$0600
;;;;;;;;		ORG	$6000
		binset	$0,$2000
FUKU_DJ_CHR	libbin	cgx/frcgba.cgx
...
;;;;;;;;		ORG	$7cb0
		binset	$0,$02d0
Photo_scr	libbin	photo/album_gm.csd
