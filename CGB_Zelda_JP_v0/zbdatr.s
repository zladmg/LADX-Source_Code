...
cz_8_epn	EQU	$5220
		ORG	$5220
		binset	$0,$400
		libbin	atr2/cz_8-epn.pdt
;
pnl_06_bank	EQU	Bank_27
pnl_06		EQU	$5620
		ORG	$5620
		binset	$0,$400
		libbin	atr2/06pnl.pdt
;
pnl_08_bank	EQU	Bank_27
pnl_08		EQU	$5a20
		ORG	$5a20
		binset	$0,$400
		libbin	atr2/08pnl.pdt
;
pnl_0e_bank	EQU	Bank_27
pnl_0e		EQU	$5e40
		ORG	$5e40
		binset	$0,$400
		libbin	atr2/0epnl.pdt
;
pnl_1a_bank	EQU	Bank_27
pnl_1a		EQU	$6240
		ORG	$6240
		binset	$0,$400
		libbin	atr2/1apnl.pdt
;
cz_2_8pn_bank	EQU	Bank_27
cz_2_8pn	EQU	$6640
		ORG	$6640
		binset	$0,$400
		libbin	atr2/cz_2-8pn.pdt
;
cz_2_fpn_bank	EQU	Bank_27
cz_2_fpn	EQU	$6a40
		ORG	$6a40
		binset	$0,$400
		libbin	atr2/cz_2-fpn.pdt
;
cz_4_cpn_bank	EQU	Bank_27
cz_4_cpn	EQU	$6e40
		ORG	$6e40
		binset	$0,$400
		libbin	atr2/cz_4-cpn.pdt
;
;========================================================
;	ダンジョンアトリビュート（ＢＡＮＫ２３）
;========================================================
