...
;*	ÉtÉ@ÉCÉãñº  ÅF	ZS1SUB.S					*
;*	èàóùì‡óe    ÅF	ÉIÅ[ÉvÉjÉìÉOèàóù				*
;*	çÏê¨ì˙ït    ÅF  ÇPÇXÇXÇWÅ^ÇPÇOÅ^ÇQÇO				*
;*									*
;************************************************************************
...
;
	LD	A,LOGOS		; Ç¢Ç´Ç»ÇËÉ^ÉCÉgÉãÉçÉS
	LD	(VRFLG),A
;
;-------------------------------------------------------------
		LD	A,(CGBFLG)
...
;(SOUND TEST)		XOR	A
;(SOUND TEST)		LD	($ff24),A	; ÉTÉEÉìÉhÇnÇeÇe
;(SOUND TEST)		LD	(SLEVEL),A	; ÉTÉEÉìÉhÉåÉxÉãÇP ÇlÇhÇm
;(SOUND TEST)		LD	(SLEVEL2),A	; ÉTÉEÉìÉhÉåÉxÉãÇQ ÇlÇhÇm
...
OPN080
	...
	DW	OPF9000 ; (D) Ç¢Ç´Ç»ÇËÉ^ÉCÉgÉãÉoÉìÉNÉZÉbÉgÅI
;
OP8	EQU	$3
OP9	EQU	$4
OPAF	EQU	$5
...
DX_oam_xpos	EQU	$79		; ÇwÉ|ÉWÉVÉáÉì
DX_oam_ypos	EQU	$46		; ÇxÉ|ÉWÉVÉáÉì
;------------------------------------------------------------------------
...
DX_CGB_COLSET
		...
		ADD	HL,BC
		LD	BC,CGWORK+0068H	; ÉAÉgÉäÉrÉÖÅ[ÉgÇUÅïÇV
		LD	E,$18
DXCSET_100
		LD	A,(HLI)
		LD	(BC),A
