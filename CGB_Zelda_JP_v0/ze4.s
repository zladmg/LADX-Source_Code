...
;-------------<	ZPL >-------------
		...
		EXTERN	YOSSISET,NAZOCLR,NOSDST,NXGOTO3,LDTIM1,LDTIM3,MSGCH3
		EXTERN	DUSHCL2,CARITMD,PTOBI,PBULE,POVER,PINDR1,PMOVE,PFOLE
		EXTERN	PTATE,PMGIC,POKAR,FDIN,PSWIM,ENDG,GMAP,GPLAY
;
;-------------<	ZES >-------------
		...
		EXTERN	SADWSTL,SHRVSE,ITEMGETS,ENBITON,ENMDSTL,EFAIL,EFOLE,EFIRE
		EXTERN	EINIT,EMOVE,ESTOP,ECACH,ESHOT,ENONBT
;
;-------------<	ZBS >-------------
		EXTERN	DJRMRD,FKMSCK,HABATAKI
;
;-------------<	ZMA >-------------
		EXTERN	PBSET,FUKU_YOUSEI_SUB,FLY_KONA_SUB
		EXTERN	FK_BOSS_KOBUN_SUB
;
;==============	バンク２ ================================================
BANK2		GROUP	2
;-------------<	ZEX >-------------
		EXTERN	SPUNDT,WTUP,SMK1,RZNZ,FLSH,BFZN,DSZN
;
;==============	バンク３ ================================================
BANK3		GROUP	3
;-------------<	ZEN >-------------
		EXTERN	EFLSST,BHFIR,HARTB,R7BEM,RENO7,BGKAO,FUCKS,UFOCH,TERSA
		EXTERN	FISHG,SBOMB,BOMBR,NINTM,HAYAB,KTOBJ,BSLIM,SLIMB,TBOSS
		EXTERN	BSNAK,GORMA,BSKEL,BFIRE,BBIRD,SWBLK2,BFISH,SWTRP,NIWAT
		EXTERN	KODOMA,PAPA0,KAMEI,RANEM,PANEL,BHANA,SHANA,HEIS0,MORI1
		EXTERN	OCTA1,KODOMB,IZUMI,SONIC,KEYSM,MIZUB,SLOT,HART1,RUPY1
		EXTERN	OCHAN,KAKIN,SLIMS,OZWAN,HINO0,NOMOS,KODOMC,URURI,TRYCY
;
;==============	バンク８ ================================================
BANK8		GROUP	8
;-------------<	ZBD >-------------
...
;;;KK;;;	DB	$3C,$00,$3C,$20
;;;KK;;;PNCKXP
;;;KK;;;	DB	$58,$78,$78,$28,$28
;;;KK;;;	DB	$28,$78,$58,$28,$78
;;;KK;;;	DB	$28,$78,$28,$78,$58
;;;KK;;;	DB	$58,$28,$78,$28,$78
;;;KK;;;PNCKYP
;;;KK;;;	DB	$40,$30,$50,$50,$30
;;;KK;;;	DB	$30,$50,$40,$50,$30
;;;KK;;;	DB	$50,$50,$30,$30,$40
;;;KK;;;	DB	$40,$50,$30,$30,$50
;;;KK;;;;- - - - - - - - - - - - - - - - - - - 
;;;KK;;;PNFLCD
;;;KK;;;;0
;;;KK;;;	DB	$F2,$00,$3A,$00
...
;
	...
	JR	Z,FKSD10
;
		LD	A,(CLOTHFG)	;防御力もしくは、
		AND	A		;	攻撃力ＵＰしてる？
		JR	NZ,FKSD10	;	NO --> FKSD10
;
	LD	A,$49
	LD	(SOUND4),A	;(S)
	LD	(BGMNO2),A
...
;(CGB);;	DB	$48,$00,$4A,$00
;(CGB);;	DB	$48,$00,$4C,$00
;(CGB)BLINKCD_BED			;布団の下地
;(CGB)	DB	$00,$00,$5E,$06	; 左
;(CGB)	DB	$00,$08,$5E,$26	; 右
;(CGB);- - - - - - - - - - - - - - - -
;(CGB)BDTRAD	;トウロウ場所
;(CGB)	DB	$98,$42
;(CGB)	DB	$98,$50
...
;(CGB)		LD	A,(CGBFLG)
;(CGB)		AND	A
;(CGB)		JR	Z,BEDLINKCS_100
;(CGB);
;(CGB)		LD	HL,BLINKCD_BED
;(CGB)		LD	C,$2
;(CGB)		CALL	ENOMST
;(CGB)BEDLINKCS_100
;(CGB);
