...
;-------------<	ZPL >-------------
		...
		EXTERN	LDTIM3,BG1CHG,PLPTSTL,PLSDCL,MSGCH3,DUSHCL2,NXGOTO4
		EXTERN	CARITMD,PTOBI,PBULE,POVER,PINDR1,PMOVE,PFOLE,PTATE
		EXTERN	PMGIC,POKAR,FDIN,PSWIM,PBOXER,LOVED,PEACH,KABE1,ENDG
		EXTERN	GMAP,GEKI04,GPLAY
		EXTERN	KURUD
;
;-------------<	ZES >-------------
		...
		EXTERN	CRKNENL,ENFEND,CRENPSL,ENPSSV,ENSDCL,NXOMSBL,EFOLE
		EXTERN	PLBGCKL,ENALCL,HNSMST,ENOMST,ENSZST,SADWSTL,SHRVSE
		EXTERN	ITEMGETS,ENBITON,ENMDSTL,O2MCHK,CRKNKNL,EFAIL,EFIRE
...
BANK2		GROUP	2
;-------------<	ZEX >-------------
		EXTERN	SPUNDT,SMK1,RZNZ,FLSH,FUCKS,BFZN,DSZN,WTUP2
;
;==============	バンク３ ================================================
BANK3		GROUP	3
;-------------<	ZEN >-------------
		...
		EXTERN	OZWAN,ARIMA,PYAAA,ZONBI,TODD,USAGI,ONPU,AKUMA
		EXTERN	MVHAS,WANI,GAGE,GIRL1,GIRL2
;
;==============	バンク８ ================================================
BANK8		GROUP	8
;-------------<	ZBD >-------------
